...
/// Application UseCase for listing permissions assigned to a company role.
///
/// Security Enforcement Pipeline:
/// `Caller -> NexaBizCompanyAuthorizationContext -> NexaBizPermissionGuard -> QueryStore`
final class ListRolePermissionsUseCase {
  const ListRolePermissionsUseCase({
  ...
  execute({
    ...
    return await _store.listRolePermissions(
