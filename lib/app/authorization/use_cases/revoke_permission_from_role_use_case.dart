...
/// Application UseCase for revoking a permission from a custom role.
///
...
final class RevokePermissionFromRoleUseCase {
  const RevokePermissionFromRoleUseCase({
  ...
  execute({
    ...
    // 3. Transactional Store Mutation (protects built-in roles; handles idempotent revokes)
    final result = await _store.revokePermissionFromRole(
