...
/// Application UseCase for updating presentation metadata of a custom role.
///
...
final class UpdateCompanyRoleMetadataUseCase {
  const UpdateCompanyRoleMetadataUseCase({
  ...
  execute({
    ...
    final result = await _store.updateCompanyRoleMetadata(
