...
/// Application UseCase for listing memberships assigned to a role.
///
/// Security Enforcement Pipeline:
/// `Caller -> NexaBizCompanyAuthorizationContext -> NexaBizPermissionGuard -> QueryStore`
final class ListMembershipsAssignedToRoleUseCase {
  const ListMembershipsAssignedToRoleUseCase({
  ...
  execute({
    ...
    return await _store.listRoleMemberships(
