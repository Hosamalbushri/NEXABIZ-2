...
/// Application UseCase for assigning a role to a membership.
///
...
final class AssignRoleToMembershipUseCase {
  const AssignRoleToMembershipUseCase({
  ...
  execute({
    ...
    final result = await _store.assignRoleToMembership(
