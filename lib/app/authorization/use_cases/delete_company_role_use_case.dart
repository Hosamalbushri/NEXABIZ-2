...
/// Application UseCase for deleting a custom role.
///
...
final class DeleteCompanyRoleUseCase {
  const DeleteCompanyRoleUseCase({
  ...
  execute({
    ...
    final result = await _store.deleteCompanyRole(
