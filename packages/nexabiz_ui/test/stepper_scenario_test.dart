...
void main() {
  testWidgets('StepperScenario renders 3-step wizard and steps header', (tester) async {
    await tester.pumpWidget(
      const shadcn.ShadcnApp(
        home: Scaffold(
          body: StepperScenario(isArabic: true),
        ),
      ),
    );
    await tester.pumpAndSettle();

    expect(find.text('معالج التهيئة متعدد الخطوات (AppStepper)'), findsOneWidget);
