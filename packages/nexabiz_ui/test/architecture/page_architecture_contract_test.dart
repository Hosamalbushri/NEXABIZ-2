...
void main() {
  Widget buildTestableWidget(Widget child) {
    return shadcn.ShadcnApp(home: shadcn.Scaffold(child: child));
  }
  ...
  group('Page Architecture Contract Tests', () {
    ...
    testWidgets('Rule D: Legacy AppPageShell delegates to canonical AppPage', (
      ...
      await tester.pumpWidget(
        buildTestableWidget(const AppPageShell(child: Text('Shell Content'))),
      );
    ...
    testWidgets(
      'Rule D: Legacy AppListPagePattern delegates to canonical AppListPage',
    ...
    testWidgets(
      'Rule D: Legacy AppFormPagePattern delegates to canonical AppFormPage',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          buildTestableWidget(
            AppFormPagePattern(
    ...
    testWidgets(
      'Rule D: Legacy AppDetailPagePattern delegates to canonical AppDetailsPage',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          buildTestableWidget(
    ...
    testWidgets(
      'Rule D: Legacy ModuleListScaffold delegates to AppListPagePattern & AppListPage',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          buildTestableWidget(
    ...
    testWidgets(
      'Rule D: Legacy ModuleFormScaffold delegates to AppFormPagePattern & AppFormPage',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          buildTestableWidget(
            ModuleFormScaffold(
