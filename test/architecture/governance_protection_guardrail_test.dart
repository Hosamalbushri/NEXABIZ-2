...
void main() {
  group('Guardrail 5 — Governance Contract Integrity Tests', () {
    test('Rule 5: Root AGENTS.md MUST exist and contain mandatory governance headers', () {
      final agentsFile = File('AGENTS.md');
      expect(
        agentsFile.existsSync(),
        isTrue,
        reason: 'Root AGENTS.md MUST exist as the single architecture entry point.',
      );
      ...
      expect(
        ...
        isTrue,
        reason: 'AGENTS.md must prominently contain mandatory development contract header.',
      );
      expect(
        content.contains('ARCHITECTURE DECISION REQUIRED'),
        isTrue,
        reason: 'AGENTS.md must mandate ARCHITECTURE DECISION REQUIRED on conflict.',
      );
      expect(
    ...
    test('Rule 5: All 6 mandatory architecture contracts 00-05 MUST exist in docs/architecture/', () {
